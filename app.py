...
def get_prediction(image_data):
  ...
  url = 'https://askai.aiclub.world/2a69db2d-cb3a-42b0-9b5b-065e4919a937'
...
#showing cats images
st.image("Cat_100.jpg", caption = "Picture of cats")

#showing dogs images
st.image("Dog_13.jpg", caption = "Picture of dogs")
